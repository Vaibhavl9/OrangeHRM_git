...
class EmployeeSearch:
    ...
    Text_Emp_Name_XPATH = (By.XPATH, "/html[1]/body[1]/div[1]/div[1]/div[2]/div[2]/div[1]/div[1]/div[2]/form[1]/div[1]/div[1]/"
    ...
    def Enter_EmpName(self, empname):
        self.driver.find_element(*EmployeeSearch.Text_Emp_Name_XPATH).send_keys(empname)
